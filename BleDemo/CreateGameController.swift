...
class CreateGameController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        /// 初始化
        self.myPeripheral = CBPeripheralManager(delegate: self, queue: nil, options: [CBPeripheralManagerOptionShowPowerAlertKey : true])
    }
...
extension CreateGameController: CBPeripheralManagerDelegate {
    /// 当调用添加服务的方法时，回调
